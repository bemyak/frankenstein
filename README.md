...
It's a complete wrapper for Telegram bot API, and it's up-to-date with version 10.0 of the API.
...
```toml
[dependencies]
frankenstein = { version = "0.50", features = [] }
```
